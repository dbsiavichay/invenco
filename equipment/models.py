...
class Device(models.Model):
	...
	serial = models.CharField(max_length=34, unique=True, blank=True, null=True, verbose_name='N de Serie')
	part = models.CharField(max_length=32, blank=True, null=True, verbose_name='N de Parte')
	specifications = JsonField(blank=True, null=True)
