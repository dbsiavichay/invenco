(function () {
  ...
  .controller('EquipmentController', function ($scope, Equipment, Model, Type, Department, Section, Employee, Assignment) {
    ...
    $scope.equipments = Equipment.query({'usage':1});
    $scope.types = Type.query({'usage': 1});
    $scope.models = [];
  ...
  .controller('AccessoryController', function ($scope, Equipment, Model, Type) {
    //Equipment declarations
    $scope.equipments = Equipment.query({'usage': 3});
    $scope.types = Type.query({'usage': 3});
    $scope.models = [];
    $scope.equipmentSpecifications = []
    $scope.equipmentOptions = []
    $scope.equipment = null;
